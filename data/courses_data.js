module.exports = [
  {
    ...
    "weeks": [
      ...
      },
      {
        ...
        "activity": "1. Do one round of slow breathing together in the room: in for four, out for six, five times.\n2. Role-play asking a teacher to use the safe space or show the signal card.\n3. Swap roles so the pupil hears how the request sounds from the other side.",
      ...
      },
      {
        ...
        "activity": "1. Pick one of the two strategies the pupil chose in week three and say which one you're using.\n2. Deal a role-play scenario card and act it out — you play the other person.\n3. At the moment of frustration, pause and prompt: 'which strategy, and what does it look like right now?' 4. Run it twice more with different cards, so it's rehearsed rather than discussed.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Simple rapport-building chat, interests, how the week has gone.",
        "input": "Explore the idea that rules exist to keep people safe and learning fair, not to control for its own sake. Ask questions rather than lecture.",
      ...
      },
      {
        ...
        "checkin": "Review the noticed 'hard rule' moment from last week.",
        "input": "Introduce choice-and-consequence as a neutral, factual chain rather than a moral judgement, if I do X, Y tends to happen.",
      ...
      },
      {
        ...
        "checkin": "Review how noticing a choice-and-consequence moment went this week.",
        "input": "Teach 'first, then' language and the idea of a brief pause for processing an instruction rather than an instant no.",
      ...
      },
      {
        ...
        "checkin": "Review the focus instruction from last week.",
        "input": "Contrast a defiant response ('no, and I won't explain why') with an assertive response ('I don't want to do that because... can we agree on...').",
      ...
      },
      {
        ...
        "checkin": "Review progress against Week 1's friction baseline.",
        "input": "Summarise the course, from understanding rules to practising respectful disagreement.",
        "activity": "Co-create a short, positively framed agreement (three to four expectations, plus what support the pupil gets in return) and share it with the class teacher.",
        "reflect": "What's the one part of this agreement you feel most able to keep?",
    ...
    "weeks": [
      {
        ...
        "checkin": "Simple zone check-in, which zone am I in today: calm, wobbly, overwhelmed, or shut down?",
        "input": "Introduce an emotions wheel or zones chart to expand emotional vocabulary beyond the basics.",
      ...
      },
      {
        ...
        "checkin": "Zones check-in.",
        "input": "Explain the mind-body link, emotions show up physically before we're consciously aware of them.",
      ...
      },
      {
        ...
        "checkin": "Zones check-in and review of the noticing task.",
        "input": "Teach two or three grounding techniques: the five senses technique, box breathing, or grounding through touch and texture.",
      ...
      },
      {
        ...
        "checkin": "Zones check-in and review of strategy use.",
        "input": "Introduce the idea that emotional intensity naturally peaks and falls if nothing feeds it, like a wave rather than a light switch.",
      ...
      },
      {
        ...
        "checkin": "Compare zones and mood against the Week 1 baseline.",
        "input": "Recap the course: vocabulary, body awareness, strategies, and the wave.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Rapport-building chat.",
        "input": "Introduce restorative affective questions: what happened, what were you thinking at the time, and who has been affected, and how.",
        "activity": "Use the questions to talk through one recent conflict, with the mentor noting key points neutrally.",
        "reflect": "What's one thing you'd like the other person to understand? Hold this thought for next week.",
      ...
      },
      {
        ...
        "checkin": "Review last week's reflection.",
        "input": "Introduce a simple perspective-taking technique: if I were in their shoes, what might I have been thinking or feeling?",
        "activity": "Using the same conflict from Week 1, or a hypothetical one if too raw, the pupil attempts to describe the other person's likely thoughts and feelings.",
        "reflect": "Did anything surprise you about seeing it from their side?",
      ...
      },
      {
        ...
        "checkin": "Review what surprised the pupil about seeing the conflict from the other person's side last week.",
        "input": "Explain the different roles in bullying situations, target, instigator, bystander, defender, noting most pupils move between roles rather than fitting one label.",
      ...
      },
      {
        ...
        "checkin": "Review last week's conversation about the pupil's role in the situation, and what would help if it happens again.",
        "input": "Teach the 'I statement' structure: I felt X when Y happened, and I need Z, as an alternative to blame-first language.",
      ...
      },
      {
        ...
        "checkin": "Compare to the Week 1 baseline.",
        "input": "Recap the course: perspectives, roles, and repair skills.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Rapport chat.",
        "input": "Explain that most pupils underestimate how often call-outs happen, this session is about honest noticing, not blame.",
      ...
      },
      {
        ...
        "checkin": "Review the self-tally.",
        "input": "Teach a simple impulse-control routine: pause, notice the urge to speak, and choose a response.",
      ...
      },
      {
        ...
        "checkin": "Review how 'pause, notice, choose' went this week.",
        "input": "Introduce alternative attention-getting strategies: hand up, a name card on the desk, or an agreed non-verbal signal with the teacher.",
      ...
      },
      {
        ...
        "checkin": "Review use of the signal so far.",
        "input": "Introduce a simple self-monitoring chart where the pupil rates self-control each lesson on a 1–5 scale.",
      ...
      },
      {
        ...
        "checkin": "Compare to the Week 1 baseline tally.",
        "input": "Recap the course: noticing, the impulse-control technique, the signal, and self-monitoring.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Gentle, low-pressure rapport building, anxious pupils often need extra safety before disclosure.",
        "input": "Psychoeducation on anxiety: the body's alarm system reacting to perceived threat, even when there's no real danger, and why this can happen at school.",
        "activity": "Use a simple diagram, such as a worry thermometer, to help the pupil describe how anxiety feels at school.",
      ...
      },
      {
        ...
        "checkin": "Worry thermometer check-in.",
        "input": "Explain that avoidance feels like relief short-term but keeps anxiety high long-term, the aim isn't to remove all worry, but to build tolerance gradually.",
      ...
      },
      {
        ...
        "checkin": "Review the ladder and any attempts so far.",
        "input": "Reinforce that success is defined as attempting the step, regardless of how it feels, not needing to feel calm before trying.",
      ...
      },
      {
        ...
        "checkin": "Review progress on the ladder step.",
        "input": "Teach one or two simple grounding or relaxation techniques suited to a busy school environment, such as slow breathing or grounding through the senses.",
      ...
      },
      {
        ...
        "checkin": "Review progress against the Week 1 worry thermometer baseline.",
        "input": "Recap the course: understanding anxiety, the ladder, small steps, and calming strategies.",
        "activity": "Agree the next two or three steps on the ladder with realistic timeframes, and write up a simple plan to share with the SENCO, pastoral lead and family.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Rapport chat.",
        "input": "Introduce the idea of focus as something that naturally comes and goes, the aim is noticing the drift, not forcing constant concentration.",
      ...
      },
      {
        ...
        "checkin": "Review the focus timeline.",
        "input": "Explore common disengagement triggers and normalise that everyone has some, the skill is recognising your own pattern.",
      ...
      },
      {
        ...
        "checkin": "Review which disengagement trigger came up most this week.",
        "input": "Teach practical strategies: chunking tasks into smaller steps, a visual checklist, brief movement breaks, or a designated focus object on the desk.",
      ...
      },
      {
        ...
        "checkin": "Review strategy use.",
        "input": "Explore the link between motivation and personally meaningful goals, disengagement often drops when work feels connected to something the pupil cares about.",
      ...
      },
      {
        ...
        "checkin": "Compare the focus timeline to Week 1.",
        "input": "Recap the course: noticing drift, triggers, strategies, and motivation.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Rapport-building, this module depends heavily on the pupil trusting the mentor first.",
        "input": "Open, non-judgemental exploration of what 'respect' and 'authority' mean to the pupil, without immediately linking to a specific incident.",
      ...
      },
      {
        ...
        "checkin": "Review last week's thoughts on what makes the pupil more likely to listen to an adult.",
        "input": "Introduce the idea that staff are also managing pressure, such as a full class or safety concerns, this isn't to excuse poor staff behaviour, but to build a fuller picture.",
      ...
      },
      {
        ...
        "checkin": "Review whether seeing the adult's side changed anything this week.",
        "input": "Teach a simple respectful-disagreement script, covering tone, timing (not in front of the whole class), and wording.",
      ...
      },
      {
        ...
        "checkin": "Review how the respectful-disagreement script felt when the pupil tried it this week.",
        "input": "Explain the purpose of a restorative conversation: not an apology for its own sake, but a chance to repair a specific relationship.",
      ...
      },
      {
        ...
        "checkin": "Compare to Week 1.",
        "input": "Recap the course: trust, perspective, respectful communication, and repair.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Very low-pressure, interests and favourite things, no direct questioning about friendships yet.",
        "input": "Build rapport and safety, and explain what the course is for in simple, non-clinical terms.",
      ...
      },
      {
        ...
        "checkin": "Continue rapport-building.",
        "input": "Gently explore common reasons pupils withdraw: feeling different, past rejection or bullying, sensory overwhelm in loud spaces, or simply not knowing how to join in.",
      ...
      },
      {
        ...
        "checkin": "Gently review whether an easier time or place came to mind this week.",
        "input": "Teach a simple, concrete skill: an opening line, how to ask to join an activity, or how to respond when someone starts a conversation.",
      ...
      },
      {
        ...
        "checkin": "Review the small step attempt.",
        "input": "Explore where connection might already be possible: a shared interest club, a particular peer who's been friendly, or a smaller social space.",
      ...
      },
      {
        ...
        "checkin": "Reflect on how the five weeks have felt overall.",
        "input": "Recap the course: safety first, understanding barriers, small skills, and identifying spaces to belong.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Mood check and low-pressure rapport building.",
        "input": "Introduce the idea that damaging behaviour is very often impulsive and linked to a build-up of strong emotion, not planned defiance.",
        "activity": "Walk through a recent incident using a simple timeline: what happened before, during and after, focusing on facts rather than blame.",
        "reflect": "What's the earliest point in that timeline where something could have gone differently?",
      ...
      },
      {
        ...
        "checkin": "Review how it felt to talk through the incident timeline last week.",
        "input": "Connect this module to emotional regulation, explore what feeling, such as frustration, humiliation or overwhelm, usually precedes the urge.",
      ...
      },
      {
        ...
        "checkin": "Review what came up when the pupil noticed the feeling before the urge this week.",
        "input": "Introduce safe outlets for the same physical urge: squeezing a stress object, tearing scrap paper, a brief supervised movement break, or pushing against a wall.",
      ...
      },
      {
        ...
        "checkin": "Review use of the alternative outlet.",
        "input": "Introduce the idea of repair: understanding the real impact, such as cost, time and the feelings of others affected, and what putting it right could look like.",
      ...
      },
      {
        ...
        "checkin": "Compare to the Week 1 baseline.",
        "input": "Recap the course: understanding the trigger-emotion-action chain, safe alternatives, and repair.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Rapport-building chat and a 1–5 mood scale to open.",
        "input": "Introduce an anger thermometer showing a range from mild irritation to rage, contrasted with 'angry' as the only word most pupils reach for.",
      ...
      },
      {
        ...
        "checkin": "Review the naming task from the week.",
        "input": "Explain that triggers differ by setting, schoolwork frustration, social triggers and home triggers can all feel different.",
      ...
      },
      {
        ...
        "checkin": "Review the tracked trigger from last week.",
        "input": "Introduce 'the gap', the space between feeling angry and choosing a response, and strategies to widen it, such as counting, stepping away, or brief self-talk.",
      ...
      },
      {
        ...
        "checkin": "Check whether the STOP technique was used this week and troubleshoot any barriers.",
        "input": "Contrast passive, aggressive and assertive responses using simple real-life examples.",
      ...
      },
      {
        ...
        "checkin": "Review progress across the five weeks using the Week 1 mood scale as a comparison point.",
        "input": "Summarise what's been learned: naming feelings, personal triggers, the STOP technique, and assertive phrases.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Rapport-building chat; explain clearly and calmly that this course is about understanding and problem-solving, not getting into trouble.",
        "input": "Set out that attendance patterns usually have real, understandable reasons behind them, even when they look like simple choice from the outside.",
        "activity": "Pupil completes a non-judgemental 'attendance story', a simple timeline of when things started slipping and why, in the pupil's own words.",
        "reflect": "What's the biggest single reason attendance has dropped? Agree one thing to notice this week, something that makes attending harder, whatever form that takes for the pupil specifically.",
      ...
      },
      {
        ...
        "checkin": "Review the attendance story from Week 1.",
        "input": "Introduce a simple push/pull framework for thinking about absence.",
      ...
      },
      {
        ...
        "checkin": "Review what's happened since mapping push and pull factors.",
        "input": "Explore the idea that attendance sticks better when it's tied to something the pupil values, a friendship, a subject, a club, a target, not just a rule to follow.",
      ...
      },
      {
        ...
        "checkin": "Review progress on leaning into the chosen connection from Week 3.",
        "input": "Revisit the barrier raised in Weeks 1 and 2 in more detail. Practical barriers to attendance vary widely, transport, uniform, a specific lesson or teacher, sleep and routine, a part-time job, caring responsibilities, or a peer relationship, so this session follows whatever the pupil has actually described, rather than assuming it's about mornings or any other single cause.",
      ...
      },
      {
        ...
        "checkin": "Review progress across the five weeks.",
        "input": "Summarise what's been learned: reasons for absence, sources of connection, and the practical fixes agreed.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Quick, no-judgement check: 'How's it been going since we last spoke?' Keep the tone curious, not interrogating.",
        "input": "Explain what's in a typical vape (nicotine, flavourings, other chemicals) and how nicotine creates a short dopamine hit followed by a dip, the cycle that drives repeated use. Bust common myths (e.g. 'vaping is basically harmless') using plain, non-alarmist facts.",
      ...
      },
      {
        ...
        "checkin": "Ask how the pupil has felt about the topic since Week 1, any moments it came to mind?",
        "input": "Introduce the idea that vaping triggers are often social (offered by friends, fitting in) as well as emotional (boredom, stress, habit). Explain that naming a trigger is the first step to having a plan for it.",
      ...
      },
      {
        ...
        "checkin": "Review the trigger noticed last week, what happened?",
        "input": "Introduce a few practical refusal scripts pupils actually find usable (a short 'no thanks, trying to cut back' or changing the subject) rather than formal assertiveness scripts that can feel unnatural with friends.",
      ...
      },
      {
        ...
        "checkin": "Check whether the refusal response got used, and how it went, without judgement either way.",
        "input": "Introduce simple reduction strategies for pupils who vape regularly (delaying by 10 minutes, swapping a fidget or drink for the habit moment) alongside staying-vape-free strategies for pupils who don't currently use.",
      ...
      },
      {
        ...
        "checkin": "Review progress across the five weeks, what's changed since Week 1's 'where am I now' scale?",
        "input": "Summarise what's been covered: how nicotine dependence works, personal triggers, and refusal or reduction strategies that felt usable.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Simple, warm opening: 'Tell me a bit about your week at home, if you'd like to.' No pressure to share more than feels comfortable.",
        "input": "Explain what a 'young carer' means in plain terms, any young person who helps look after a family member with an illness, disability, mental health condition or addiction, and that it's a recognised, valued role, not a secret to be ashamed of.",
        "activity": "Pupil completes a simple 'a day in my life' timeline, marking where caring tasks fit alongside school and free time, at whatever level of detail feels comfortable.",
        "reflect": "What's one thing about your role you're proud of? Agree nothing formal yet, Week 1 is about being heard.",
      ...
      },
      {
        ...
        "checkin": "Review the timeline from Week 1, anything the pupil noticed since then?",
        "input": "Introduce the idea of a 'time balance', caring, school, and personal time all matter, and it's common for one to squeeze out the others without anyone planning it that way.",
      ...
      },
      {
        ...
        "checkin": "Check in on the tight moment noticed last week, what happened, and how did the pupil manage it?",
        "input": "Introduce the idea that even short moments of rest or connection count as self-care, it doesn't need to be a big block of free time to make a difference.",
      ...
      },
      {
        ...
        "checkin": "Review how the chosen 'what helps' strategy went this week.",
        "input": "Introduce local young carers services and school-based support (pastoral lead, young carers lead if the school has one) as places built specifically to help, not as a sign that something has gone wrong.",
      ...
      },
      {
        ...
        "checkin": "Review the five weeks together, what feels different from Week 1's timeline?",
        "input": "Summarise what's been covered: understanding the role, balancing time, coping strategies, and support available.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Open, low-pressure question: 'What apps or games do you spend most time on at the moment?' Build rapport through genuine curiosity, not assessment.",
        "input": "Introduce the idea that our online life is a real part of our life, what happens there matters just as much as what happens in person, and it's normal for it to feel good sometimes and uncomfortable other times.",
        "activity": "Pupil maps a typical day's online activity (apps, platforms, who the pupil talks to) and marks which parts feel positive, neutral, or uncomfortable using a simple colour code.",
        "reflect": "What's one part of your online day that feels genuinely good? Agree to simply notice one uncomfortable moment this week, without needing to act on it yet.",
      ...
      },
      {
        ...
        "checkin": "Review the uncomfortable moment noticed last week, if the pupil is willing to share.",
        "input": "Explain that cyberbullying includes things like exclusion from group chats, nasty comments, sharing embarrassing content without consent, and impersonation, and that it can feel just as serious as in-person bullying, sometimes more so because it can follow a pupil home.",
        "activity": "Pupil sorts a set of scenario cards into 'cyberbullying', 'unkind but not bullying', and 'not sure' categories, discussing the harder-to-classify ones together.",
        "reflect": "Has anything like this happened to you or someone you know? Agree there's no pressure to share details yet.",
      ...
      },
      {
        ...
        "checkin": "Check how the week went since discussing cyberbullying scenarios.",
        "input": "Walk through practical safety steps: adjusting privacy settings, blocking and reporting on common platforms, and taking screenshots as evidence before blocking (since blocking can sometimes hide the original message).",
      ...
      },
      {
        ...
        "checkin": "Review the privacy setting checked last week.",
        "input": "Introduce the idea that telling an adult early, before something escalates, gives more options for resolving it, and that this is a sign of good judgement, not weakness.",
      ...
      },
      {
        ...
        "checkin": "Review the five weeks, what feels different about the pupil's digital day map from Week 1?",
        "input": "Summarise what's been covered: recognising cyberbullying, staying safe online, and speaking up early.",
        "activity": "Co-create a one-page digital wellbeing plan: privacy steps to keep in place, a screen time or bedtime boundary the pupil chooses, and the name of the trusted adult the pupil would go to.",
        "reflect": "What's one thing you feel more confident about now? What would help most going forward?",
    ...
    "weeks": [
      {
        ...
        "checkin": "Mood check using a 1–5 scale, with a simple opening: 'How's exam pressure feeling at the moment?'",
        "input": "Explain the stress response in plain terms: the body reacting to exams as if they were a real threat, which is why hearts race and thoughts speed up, and that some stress is normal and even useful, but too much stops the brain working well.",
      ...
      },
      {
        ...
        "checkin": "Review the physical signal noticed last week.",
        "input": "Introduce catastrophic thinking ('if I fail this, everything's ruined') and explain how it makes stress worse, using a simple thought-balance technique: what's the evidence for this thought, and what's a more balanced version?",
      ...
      },
      {
        ...
        "checkin": "Check how the thought-balance technique went this week.",
        "input": "Introduce the idea that a sustainable routine beats a perfect one, short, regular sessions with breaks work better than long, exhausting ones, and rest is part of the plan, not a reward for finishing it.",
      ...
      },
      {
        ...
        "checkin": "Review how the routine worked this week and adjust anything that didn't fit.",
        "input": "Introduce practical on-the-day strategies: slow breathing before entering the exam room, grounding techniques if the mind goes blank, and a short phrase to use if panic starts to build.",
      ...
      },
      {
        ...
        "checkin": "Review progress across the five weeks using the Week 1 stress thermometer as a comparison point.",
        "input": "Summarise what's been learned: the stress response, reframing catastrophic thoughts, a workable routine, and on-the-day coping strategies.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Simple, low-pressure opening: 'How has school felt this week, any particularly loud, bright or busy moments?'",
        "input": "Introduce the idea that everyone's senses work a bit differently, and that finding certain sounds, lights, textures or smells more intense isn't wrong, it's useful information for building the right support.",
      ...
      },
      {
        ...
        "checkin": "Review the sensory moment noticed last week.",
        "input": "Explain that certain environments, busy corridors, assembly, the lunch hall, PE changing rooms, combine several sensory challenges at once, which is why they're often the hardest moments of the day.",
      ...
      },
      {
        ...
        "checkin": "Review the timeline from last week, any new insights?",
        "input": "Introduce a range of practical sensory tools: ear defenders or earplugs, fidget tools, sunglasses or a cap for bright light, a quiet space or pass, and movement breaks, explaining these are aids, not treats to be earned.",
        "activity": "Pupil tries out two or three tools in the session (where available) and picks which feel most helpful, adding them to a personal toolkit list.",
        "reflect": "Which tool felt most useful? Agree to try it once this week in a real moment, not just in the session.",
      ...
      },
      {
        ...
        "checkin": "Check whether the chosen tool got used this week and how it went.",
        "input": "Introduce the idea of a simple signal (a card, a phrase, a gesture) that lets staff know a sensory break is needed, without requiring a full explanation in the moment.",
      ...
      },
      {
        ...
        "checkin": "Review progress across the five weeks using the Week 1 sensory profile as a comparison point.",
        "input": "Summarise what's been learned: personal sensory profile, hardest environments, useful tools, and a signal for communicating needs.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Gentle, unhurried opening: 'However you're feeling today is completely okay to bring here.'",
        "input": "Explain that grief doesn't follow a fixed order or timeline, and that anger, numbness, guilt, relief, or even moments of ordinary happiness can all be part of it, none of these mean the person is grieving 'wrong'.",
        "activity": "Pupil looks through a set of feeling word cards and picks any that have felt true for the pupil recently, at whatever pace feels comfortable, with no requirement to explain each one.",
        "reflect": "Was there a feeling on the cards that surprised you? Agree there's no 'right' way to feel this week.",
      ...
      },
      {
        ...
        "checkin": "Check in gently on how the week has felt, without assuming progress or worsening.",
        "input": "Introduce a few simple tools for expressing feelings that are hard to put into words directly, drawing, a feelings thermometer, or writing a short note that doesn't need to be shared.",
      ...
      },
      {
        ...
        "checkin": "Review how expressing feelings went last week.",
        "input": "Explain that certain days, birthdays, anniversaries, holidays, often bring grief back more strongly, even after things have felt more settled, and that having a plan for those days can help.",
      ...
      },
      {
        ...
        "checkin": "Check how the hard day toolkit conversation felt, if a date has passed or is approaching.",
        "input": "Introduce the idea that staying connected to memories, rather than avoiding them, is often part of healthy grieving, and that there's no single right way to remember someone.",
        "activity": "Pupil creates a memory activity of the pupil's choosing: a memory box list, a letter to the person who died, or a page of favourite memories, sharing only what the pupil wants to.",
        "reflect": "What was it like to spend time with this memory today? Agree to add to it whenever feels right, with no deadline.",
      ...
      },
      {
        ...
        "checkin": "Review the five weeks together gently, what's felt most useful?",
        "input": "Summarise what's been covered: understanding grief, expressing feelings, coping with hard days, and keeping memories. Explain that grief support often needs more than five weeks, and that's normal.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Warm, general opening: 'Let's talk today about friendships and relationships in general, nothing specific needed.'",
        "input": "Introduce the difference between healthy relationships (mutual respect, equal say, no pressure) and unhealthy ones (control, secrecy, one-sided favours or pressure) using everyday, relatable examples rather than frightening scenarios.",
        "activity": "Pupil sorts a set of relationship scenario cards into 'healthy', 'unhealthy', or 'not sure', discussing the reasoning behind each one together.",
        "reflect": "What's one thing that makes a relationship feel safe to you? Agree there's no need to share anything personal today.",
      ...
      },
      {
        ...
        "checkin": "Review the healthy relationship discussion from last week in general terms.",
        "input": "Explain, in plain and non-frightening language, common tactics: being singled out for special attention, being given gifts or money that create a sense of obligation, being isolated from friends or family, and being told to keep secrets from people who care about them.",
      ...
      },
      {
        ...
        "checkin": "Check in generally on how the week has been.",
        "input": "Introduce the idea that exploitation often targets a need for belonging, attention, or status, and that building a strong, independent sense of self-worth is one of the best protections against manipulation.",
        "activity": "Pupil completes a strengths and values activity, identifying what matters to the pupil and what the pupil is proud of, separate from any relationship or group's approval.",
        "reflect": "What's one strength you have that no one can take away from you? Agree to notice this strength once this week.",
      ...
      },
      {
        ...
        "checkin": "Review the strength noticed last week.",
        "input": "Introduce simple, assertive refusal language ('no, I'm not doing that' with no explanation needed) and the idea that a genuinely caring relationship will respect a 'no' without pressure or punishment.",
      ...
      },
      {
        ...
        "checkin": "Review the five weeks together in general terms, what's felt most useful?",
        "input": "Summarise what's been covered: healthy relationships, recognising tactics, self-worth, and assertive refusal. Introduce reporting routes clearly: the designated safeguarding lead at school, Childline, and the police in an emergency.",
        "activity": "Co-create a simple safety card: two trusted adults, the school's safeguarding contact, and Childline's number, kept somewhere private and accessible.",
        "reflect": "Who's one adult you'd feel comfortable going to if something didn't feel right? Agree this card is just for the pupil's own reference, no pressure to use it.",
    ...
    "weeks": [
      {
        ...
        "checkin": "Open, warm question: 'How are you feeling about the move at the moment, excited, worried, a bit of both?'",
        "input": "Start by naming the specific move this course is supporting: moving from primary to secondary school (Year 6 to Year 7), moving to a different school mid-year, or moving up to the next key stage within the same school. Agree this with the pupil so 'the move' and 'the new setting' have a concrete meaning for the rest of the course. Then explain that feeling mixed about a big change is completely normal, and that naming specific worries, rather than a vague sense of dread, makes them much easier to plan for.",
      ...
      },
      {
        ...
        "checkin": "Review the biggest worry named last week.",
        "input": "Introduce the idea that unfamiliarity is one of the biggest drivers of transition anxiety, and that building practical familiarity, routes, timetables, what to bring, reduces uncertainty directly.",
      ...
      },
      {
        ...
        "checkin": "Check how preparing the practical first-day item went.",
        "input": "Introduce simple, low-pressure ways to start conversations and join groups (a shared interest question, sitting near others at lunch, joining a club early on) rather than expecting instant close friendships.",
      ...
      },
      {
        ...
        "checkin": "Review how the social rehearsal from last week felt.",
        "input": "Introduce simple coping tools for uncertainty: slow breathing, a comforting object or reminder from home, and a plan for who to find if something feels overwhelming on a given day.",
      ...
      },
      {
        ...
        "checkin": "Review the five weeks using the Week 1 worries and hopes chart as a comparison point.",
        "input": "Summarise what's been covered: naming specific worries, practical familiarity, social strategies, and coping tools for uncertainty.",
