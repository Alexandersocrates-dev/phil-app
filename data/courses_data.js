  ...
  },
  {
    ...
    "weeks": [
      ...
      },
      {
        ...
        "activity": "1. Read out a scenario card — being asked to move seats, being asked to start work.\n2. Ask: 'what are the different things you could do here?'\n3. For each choice, ask: 'and what would probably happen next?' Match the outcome cards to it.\n4. Run two or three scenarios, including one where the good choice is genuinely hard.",
  ...
  },
  {
    ...
    "weeks": [
      ...
      },
      {
        ...
        "activity": "1. Take the same fall-out as last week, or a made-up one if that's still too raw.\n2. Ask: 'if you were them, what do you think you'd have been thinking?' Pupil fills that into the perspective-taking worksheet.\n3. Ask: 'and how do you think they were feeling?' Add that too.\n4. Make clear this isn't agreeing with them — it's working out what was going on for them.",
  ...
  },
  {
    ...
    "weeks": [
      ...
      },
      {
        ...
        "activity": "1. Ask: 'what are the bits of school you'd get out of if you could?'\n2. Pupil writes each one onto the avoidance ladder.\n3. Put them in order together, easiest at the bottom, hardest at the top.\n4. Be specific: not 'lessons', but 'walking into maths late'.",
      ...
      },
      {
        ...
        "input": "1. Recap the four parts: what anxiety is, the avoidance trade, small steps, grounding.\n2. Ask which one they'd want a teacher to know about.\n3. Keep that answer — it goes into the plan in their own words later in this session.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'think of a lesson this week — when were you actually working, and when did you drift?'\n2. Pupil marks those points on the focus timeline.\n3. Ask: 'how long did you last before the first drift?'\n4. Be clear that everyone drifts — you're finding the pattern, not the failure.",
      ...
      },
      {
        ...
        "activity": "1. Get out a real piece of their classwork, not a made-up task.\n2. Break it into parts together on the chunking checklist.\n3. Pupil works on the first chunk for five minutes while you time it.\n4. Ask: 'was that easier or harder than doing the whole thing?'",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'is there an adult anywhere — school or not — who you actually get on with?'\n2. Ask: 'what do they do that's different?' Use the discussion prompts if it stalls.\n3. Note their words in the box below — that list is what they need from staff.\n4. If they can't name anyone, ask what an adult would have to do to earn it.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'what do you like doing when you're not in lessons?'\n2. Pupil picks something from the low-pressure activity ideas, or their own.\n3. Do it together and talk about that, not about school.\n4. Don't push towards the topic — this session is for them getting used to you.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'can you talk me through what happened, from before it started?'\n2. Pupil fills the incident timeline: before, during, after.\n3. Stick to facts — what happened and when, not whose fault it was.\n4. Ask: 'how long was it between the first annoyance and the damage?'",
      ...
      },
      {
        ...
        "activity": "1. Ask: 'what were you feeling just before the urge?' Pupil picks a word from the feelings scale.\n2. Ask: 'and where did you feel it in your body?' Pupil ticks those areas on the body map.\n3. Ask: 'what did it feel like there?' Note their words in the box below.\n4. Make the link out loud: the body knew before the hands moved.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'which of these words have you actually felt?' Pupil picks from the feeling word cards.\n2. Pupil places each one on the anger thermometer, coolest at the bottom.\n3. Take two or three and ask: 'when was the last time you felt that one?'\n4. Point out the gap between the words they use and the words they've just placed.",
      ...
      },
      {
        ...
        "activity": "1. Take one setting at a time: school first, then friends, then home.\n2. Pupil writes their triggers into that column of the triggers map.\n3. Pupil rates each one for how strongly it lands.\n4. Ask: 'which column has the most, and does that surprise you?'",
      ...
      },
      {
        ...
        "activity": "1. Say an aggressive line out loud: 'this is stupid, I'm not doing it'.\n2. Pupil finds an assertive version of the same thing, using the phrase bank.\n3. Role-play it: you give the instruction, they use their version.\n4. Do it twice more until it sounds like something they'd say in a real lesson.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Read out a true/false card and ask: 'true or false, do you reckon?'\n2. Give the answer plainly, without a lecture, and move to the next.\n3. Ask: 'which of those surprised you?'\n4. Pupil marks where they'd put themselves on the where-am-I-now scale. No reaction to the answer.",
      ...
      },
      {
        ...
        "activity": "1. Pupil picks two refusal lines from the cards they'd actually say.\n2. Reword them together until they sound like the pupil, not a leaflet.\n3. Role-play an offer: you offer, they refuse. Do it three times with different scenario cards.\n4. Push once, the way a friend would, so they've practised the second refusal too.",
      ...
      },
      {
        ...
        "activity": "1. Ask: 'are you cutting down, or stopping altogether?' Follow whichever they say.\n2. Pupil picks one strategy card that fits that answer.\n3. Role-play a moment of boredom, then one of stress, using the strategy each time.\n4. Ask: 'which of those two moments is harder?'",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'can you talk me through a normal day, from waking up?'\n2. Pupil fills in the day timeline as they go — school, caring, anything that's theirs.\n3. Let them keep it vague if they want to. The detail matters less than being heard.\n4. Ask: 'is that a normal day, or a good one?'",
      ...
      },
      {
        ...
        "activity": "1. Ask: 'what actually helps, even a bit?' Pupil writes each one onto the what-helps list.\n2. Prompt with the five-minute reset ideas if the list stalls — short things count.\n3. Ask: 'which of those could you do on a bad day, not just a good one?'\n4. Pupil marks that one.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'talk me through a normal day online — what do you open first?' Pupil fills in the digital day map.\n2. Ask: 'who are you actually talking to on each one?'\n3. Pupil colours each part using the key: good, fine, or uncomfortable.\n4. Ask about anything marked uncomfortable: 'what makes that one feel like that?'",
      ...
      },
      {
        ...
        "activity": "1. Pupil picks an opening line from the cards, or writes their own.\n2. Role-play it: you're the adult, they start the conversation.\n3. Do it once with you responding well, once with you distracted, so they've practised both.\n4. Ask: 'who would you actually say that to?'",
      ...
      },
      {
        ...
        "input": "1. Recap the four parts: online life is real, what counts as cyberbullying, screenshot-block-report, telling early.\n2. Ask which one they'd tell a younger pupil.\n3. Keep that answer — it goes at the top of their plan later in this session.",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Ask: 'where does exam stress show up in your body?' Pupil ticks those areas on the body map.\n2. Ask: 'what does it feel like there?' Note their words in the box below.\n3. Pupil marks where they are now on the exam stress thermometer.\n4. Say plainly that the body doing this is normal, not a sign they can't cope.",
      ...
      },
      {
        ...
        "activity": "1. Do one breathing technique together now, properly, not just described.\n2. Pupil picks the coping strategy card they'd use on the day.\n3. Role-play walking into the exam room and using it — stand up and do it.\n4. Ask: 'what would make it hard to remember in the moment?'",
    ...
    "weeks": [
      {
        ...
        "activity": "1. Take one sense at a time: sound, light, touch, smell, being crowded.\n2. For each, ask: 'is that fine, is it bearable, or is it too much?' Pupil marks the sensory profile scale.\n3. Use the examples card if a sense is hard to picture.\n4. Ask: 'which one of those is worst at school?'",
      ...
      },
      {
        ...
        "activity": "1. Pupil designs their signal or exit card — it has to be something they'd hold up in front of others.\n2. Role-play a busy moment: they use the card, you respond.\n3. Do it again with you not noticing at first, so they've practised repeating it.\n4. Ask: 'which teacher would be easiest to try this with?'",
  ...
  },
  {
    ...
    "weeks": [
      ...
      },
      {
        ...
        "activity": "1. Ask: 'would it be easier to say it, write it, or draw it?' Follow whichever they pick.\n2. Pupil marks where they are on the feelings thermometer first, so there's a starting point.\n3. Pupil expresses one feeling in their chosen way, using the private note if they'd rather not say it aloud.\n4. Make clear you won't read it unless they want you to.",
  ...
  },
  {
    ...
    "weeks": [
      ...
      },
      {
        ...
        "activity": "1. Get out the layout guide and ask: 'how are you actually getting there?'\n2. Walk through the day on the map: arriving, finding a room, lunch, home.\n3. Ask: 'where would you go if you got lost?'\n4. Pupil fills in the first day checklist — what's in the bag, what time they leave.",
      ...
      },
      {
        ...
        "activity": "1. Pupil picks two openers from the prompt cards that they'd actually say.\n2. Role-play it: you're a new classmate, they start the conversation.\n3. Do it once where you reply well, once where you're short with them.\n4. Ask: 'what would you do if they didn't say much back?'",
